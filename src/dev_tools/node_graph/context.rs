// src/dev_tools/graph_visualizer/context.rs
use bevy::math::Vec2;
use bevy::prelude::Resource;
use bevy_egui::egui;

// use bevy_inspector_egui::bevy_egui; // Entfernen oder auskommentieren, falls nicht sofort benötigt
use derivative::Derivative;
use rand_distr::num_traits::ToPrimitive; // Könnte benötigt werden, ggf. hinzufügen
use std::collections::HashMap;

// Passe diese 'use' Anweisungen an die neuen Dateinamen an:
use super::ui_link::*; // statt use super::link::*;
use super::ui_node::*; // statt use super::node::*;
use super::ui_pin::*; // statt use super::pin::*;

pub use {
    super::ui_node::NodeArgs,
    super::ui_pin::{AttributeFlags, PinShape, PinStyleArgs},
    super::ui_style::{ColorStyle, Style, StyleFlags},
};
...
impl NodesContext {
    ...
    pub fn show(
        ...
        ui.painter().rect_stroke(
            self.frame_state.canvas_rect_screen_space,
            egui::CornerRadius::ZERO, // Updated from deprecated Rounding
            egui::Stroke::new(
                // Stroke explizit
                1.0,
                self.settings.style.colors[ColorStyle::GridLine as usize],
            ),
            egui::StrokeKind::Inside, // Fehlendes Argument
        );
        response
    }
            ...
            painter.set(
                ...
                egui::Shape::rect_stroke(
                    ...
                    egui::CornerRadius::same(
                        node.state.layout_style.corner_rounding.to_u8().unwrap(),
                    ), // Updated from deprecated Rounding
                    egui::Stroke::new(
    ...
    fn click_interaction_update(&mut self, ui: &mut egui::Ui) {
        match self.state.click_interaction_type {
            ClickInteractionType::BoxSelection => {
                ...
                ui.painter().rect(
                    rect,
                    egui::CornerRadius::same(0), // Updated from deprecated Rounding
                    box_selector_color,          // Fill color
                    egui::Stroke::new(1.0, box_selector_outline), // Stroke explizit
                    egui::StrokeKind::Inside,    // Fehlendes Argument// StrokeKind hinzugefügt
                );
